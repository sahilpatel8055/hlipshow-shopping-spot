...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", href: "/favicon.png?v=6", type: "image/png", sizes: "192x192" },
      { rel: "shortcut icon", href: "/favicon.png?v=6" },
      { rel: "apple-touch-icon", href: "/favicon.png?v=6", sizes: "192x192" },
